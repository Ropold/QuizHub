...
export const ALL_CATEGORIES_NO_K: CategoryEnum[] = ["ART", "GENERAL_KNOWLEDGE", "GEOGRAPHY", "HISTORY", "LITERATURE", "MATHEMATICS", "MOVIES_AND_TV", "MUSIC", "POLITICS", "SCIENCE", "SPORTS"];
